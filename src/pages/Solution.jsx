...
export default function Solution() {
  ...
  const fetchQuestions = useCallback(async () => {
    try {
      ...
      const response = await fetch('${API}/api/questions', { headers });
                        ...
                        <div>
                          <button onClick={async () => {
                            try {
                              ...
                              const url = `${API}/api/questions/${selectedQuestionDetail._id}/answers/${aid}`;
                              ...
                              if (!res.ok) {
                                ...
                                // fallback POST
                                const fallbackUrl = `${API}/api/questions/${selectedQuestionDetail._id}/answers/delete`;
